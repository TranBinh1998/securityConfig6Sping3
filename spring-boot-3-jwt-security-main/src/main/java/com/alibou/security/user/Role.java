...
public enum Role {
// enum là kiểu dữ liệu đặc biệt. Đại diện cho 1  nhóm hằng số có tên. Các enum luôn là static(tĩnh), final(hằng số, public())

  USER(Collections.emptySet()), // Hằng số người dùng

  ADMIN( // Hằng số Là admin
          Set.of(
                  ADMIN_READ,
                  ADMIN_UPDATE,
                  ADMIN_DELETE,
